...
- **Flyway activo (`ddl-auto=validate`):** las migraciones van en `backend/src/main/resources/db/migration/` (ya hay **V1–V36**; la próxima libre es **V37**). Cualquier cambio de schema necesita un archivo nuevo. **No cambiar a `ddl-auto=update`.**
...
```
(al 2026-09-14: 71 tests, 1 skipped, 0 fallas)
