...
function ActivateAccountPage() {
  ...
  return <div style={{ maxWidth: 480, margin: '80px auto', padding: '0 20px', textAlign: 'center' }} className="card">
    ...
    {estado === 'ok' && <><h1 style={{ fontSize: 25 }}>¡Email activado!</h1><p style={{ margin: '10px 0 22px', color: 'var(--color-text-muted)' }}>Volvé a los pasos del sorteo para continuar.</p><Link className="btn btn-primary" to="/sorteo">Volver al sorteo</Link></>}
