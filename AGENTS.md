...
- **AI:** Codex Haiku 4.5 (`Codex-haiku-4-5-20251001`) — parsing de listas de precios + búsqueda de imágenes
...
| `ANTHROPIC_API_KEY` | Codex API para parsing e imágenes |
| `ANTHROPIC_MODEL` | Modelo IA (default: `Codex-haiku-4-5-20251001`) |
